...
/// Returns the filename of a Dynlint library.
///
/// # Examples
///
/// ```
/// use dynlint_internal::library_filename;
///
/// #[cfg(target_os = "linux")]
/// assert_eq!(
...
/// Parses the filename of a Dynlint library path into a tuple of (name, toolchain).
///
/// # Examples
///
/// ```
/// use dynlint_internal::parse_path_filename;
/// use std::path::Path;
///
/// #[cfg(target_os = "linux")]
/// assert_eq!(
