...
declare_const!(DYNLINT_DRIVER_PATH);
declare_const!(DYNLINT_LIBRARY_PATH);
declare_const!(DYNLINT_LIBS);
declare_const!(DYNLINT_LIST);
declare_const!(DYNLINT_METADATA);
declare_const!(DYNLINT_NO_DEPS);
declare_const!(DYNLINT_RUSTFLAGS);
declare_const!(DYNLINT_TOML);
...
///
/// ```
/// use dynlint_internal::env::enabled;
/// use std::env;
///
/// env::set_var("FOO", "1");
