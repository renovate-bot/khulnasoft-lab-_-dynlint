...
use dynlint_internal::cargo::current_metadata;
...
mod sort {
    ...
    #[cfg_attr(
        dynlint_lib = "assert_eq_arg_misordering",
...
mod ui {
    ...
    fn general() {
        ...
        dynlint_testing::ui_test_example(env!("CARGO_PKG_NAME"), "general");
    ...
    fn check_inherents() {
        ...
        dynlint_testing::ui_test(env!("CARGO_PKG_NAME"), tempdir.path());
    }
    ...
    fn unnecessary_to_owned() {
        ...
        dynlint_testing::ui_test_example(env!("CARGO_PKG_NAME"), "unnecessary_to_owned");
    }
    ...
    fn vec() {
        ...
        dynlint_testing::ui_test_example(env!("CARGO_PKG_NAME"), "vec");
    }
...
#[cfg_attr(
    dynlint_lib = "inconsistent_qualification",
